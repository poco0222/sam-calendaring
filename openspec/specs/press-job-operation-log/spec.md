# press-job-operation-log Specification

## Purpose
TBD - created by archiving change enhance-press-job-history-operation-log. Update Purpose after archive.
## Requirements
