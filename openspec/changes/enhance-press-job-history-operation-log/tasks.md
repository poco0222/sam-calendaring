...
- [x] 3.2 返回并展示时间、操作、结果、内容、班组、作业人员，缺失字段显示“未记录”，兄弟模具共享父作业时间线
- [x] 3.3 完成单行筛选、查询图标与文字、最近 1/3/7/30 个本地自然日、80% Drawer、JSON Boolean 翻译和诊断日志 Timeline CSS 复用
- [x] 3.4 增加历史投影和前端定向测试，覆盖新日志优先、旧作业降级、缺失主数据、日期范围和展示契约
