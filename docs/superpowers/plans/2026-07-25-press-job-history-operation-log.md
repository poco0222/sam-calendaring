...
- [x] **Task 1 / Step 1: 写失败的迁移与 Mapper 契约测试**
...
- [x] **Task 1 / Step 3: 写最小迁移、Domain 和 Mapper 实现**
...
- [x] **Task 1 / Step 4: 运行契约测试并确认通过**

重复 Step 2 命令。Expected：PASS。

- [x] **Task 1 / Step 5: 提交后端数据模型**
...
- [ ] **Task 4 / Step 4: 运行测试并确认通过**

重复 Step 2 命令。Expected：PASS。

- [ ] **Task 4 / Step 5: 提交端点与投影**
...
- [ ] **Task 5 / Step 1: 写失败的 client 与页面测试**
...
- [ ] **Task 5 / Step 3: 实现最小 QT 契约和执行边界调用**
...
- [ ] **Task 5 / Step 4: 运行测试并确认通过**

重复 Step 2 命令。Expected：PASS。

- [ ] **Task 5 / Step 5: 提交 QT 操作上报**
...
- [ ] **Task 6 / Step 3: 实现原生 AntD/Day.js/CSS 调整**
...
- [ ] **Task 6 / Step 4: 运行测试并确认通过**

重复 Step 2 命令。Expected：PASS。

- [ ] **Task 6 / Step 5: 提交历史页面**
...
- [ ] **Task 7 / Step 5: 按已选择的 review_mode 完成代码审查**
...
- [ ] **Task 7 / Step 6: 记录 Comet build evidence 并检查任务**
